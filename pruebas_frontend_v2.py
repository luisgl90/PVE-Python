...
class UI_Vehiculo(QDialog):
	def __init__(self):
		...
		uic.loadUi("interfaz_datos_vehiculo_v2.ui",self)
		self.setWindowIcon(QIcon('icons/Univalle.png'))
...
class UI(QMainWindow):
	def __init__(self):
		...
		self.datosVehiculoUI = UI_Vehiculo()
		...
		self.label_c_5.setToolTip('Ancho de llanta delantera derecha sin achatar.')
		self.label_c_6 = self.findChild(QLabel,"label_cog_6")
		self.label_c_6.setText("𝒅<sub>w izq</sub> (mm)")
		self.label_c_6.setToolTip('Ancho de llanta delantera izquierda sin achatar.')
		self.label_c_7 = self.findChild(QLabel,"label_cog_7")
		self.label_c_7.setText("𝒅'<sub>w der</sub> (mm)")
		self.label_c_7.setToolTip('Ancho de llanta delantera derecha achatada.')
		self.label_c_8 = self.findChild(QLabel,"label_cog_8")
		self.label_c_8.setText("𝒅'<sub>w izq</sub> (mm)")
		self.label_c_8.setToolTip('Ancho de llanta delantera izquierda achatada.')
